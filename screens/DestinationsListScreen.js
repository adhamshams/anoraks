    ...
    return (
        <SafeAreaView style={styles.background}>
            <ScrollView horizontal={false} showsVerticalScrollIndicator={false} contentContainerStyle={{ gap: height * 0.02 }}>
                <Text style={{ fontSize: RFValue(25), fontWeight: '800', marginTop: height * 0.02, marginLeft: 20 }}>Group Tours</Text>
                <TouchableOpacity onPress={() => navigation.navigate('SiwaScreen')}>
                    <ImageBackground source={require('../assets/siwa.jpg')} style={{ width: width - 40, height: height * 0.25, alignSelf: 'center', backgroundColor: '#000', borderRadius: 12, display: 'flex', alignItems: 'center', justifyContent: 'center' }} imageStyle={{ borderRadius: 12, opacity: 0.7, resizeMode: 'cover' }}>
                        <Text style={{ fontSize: RFValue(25), fontWeight: '800', color: '#fff', textAlign: 'center' }}>SIWA</Text>
                    </ImageBackground>
                </TouchableOpacity>
                <TouchableOpacity>
                ...
                <TouchableOpacity>
                    <ImageBackground source={require('../assets/marsa-alam.jpg')} style={{ width: width - 40, height: height * 0.25, alignSelf: 'center', backgroundColor: '#000', borderRadius: 12, display: 'flex', alignItems: 'center', justifyContent: 'center' }} imageStyle={{ borderRadius: 12, opacity: 0.7, resizeMode: 'cover' }}>
                ...
                <TouchableOpacity>
                    <ImageBackground source={require('../assets/personalize-trip.jpg')} style={{ width: width - 40, height: height * 0.25, marginBottom: height * 0.02, alignSelf: 'center', backgroundColor: '#000', borderRadius: 12, display: 'flex', alignItems: 'center', justifyContent: 'center' }} imageStyle={{ borderRadius: 12, opacity: 0.7, resizeMode: 'cover' }}>
